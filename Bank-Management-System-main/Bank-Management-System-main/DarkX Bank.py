...
def transaction(identity, amount, choice):  # choice 1 for deposit; choice 2 for withdraw
    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            ...
            if choice == 2 and balance - amount < 1000:  # Minimum balance 1000
                return -1
            else:
                if choice == 1:
                    balance += amount
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to DarkX Bank")
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="#000000", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#000000",
                                foreground="#ffffff",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#000000",
                                     foreground="#ffffff",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#000000", borderwidth="0", disabledforeground="#a3a3a3",
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#000000", foreground="#fffffe", borderwidth="0",
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="#000000",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="#000000",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="#ffffff",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Back''',
                                 command=self.back)
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ececec",
                                 activeforeground="#000000", background="#000000", borderwidth="0",
